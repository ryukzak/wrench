...
TEST_CASES["factorial"] = TestCase(
    ...
    reference_cases=[
        Word2Word(12, 479001600, limit=4000),
        Word2Word(13, overflow_error_value, limit=4000),
        Word2Word(14, overflow_error_value, limit=4000),
        Word2Word(-1, -1, limit=4000),
        Word2Word(-2, -1, limit=4000),
    ],
    is_variant=False,
    category="_Examples_",
)
