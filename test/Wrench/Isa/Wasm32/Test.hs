...
tests =
    testGroup
        ...
        , testCase "Function calls bind params and return results" $ do
            let Wasm32St{operandStack, stopped, internalError} = runProgram functionProgram
            operandStack @?= [42]
            stopped @?= True
...
translate :: String -> Either String (Wasm32Isa Int32 (Ref Int32))
translate code =
...
programState :: [(Int, Wasm32Isa Int32 Int32)] -> Wasm32St Int32
programState instrs =
    Wasm32St
        { pc = 0
        , mem =
...
runProgram :: [(Int, Wasm32Isa Int32 Int32)] -> Wasm32St Int32
...
func :: [String] -> [String] -> Int -> Wasm32Isa Int32 Int32
