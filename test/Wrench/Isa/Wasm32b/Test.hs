module Wrench.Isa.Wasm32b.Test (tests) where
...
-- | Parse, lower, and run a wasm32b program to completion (halt or trap),
...
runSource :: String -> Either Text (Wasm32bState Int32)
runSource src = do
    ...
    where
        runToHalt :: Int -> Wasm32bState Int32 -> Either Text (Wasm32bState Int32)
