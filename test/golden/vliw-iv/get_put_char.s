...
addi t3, zero, 'X'           / nop             /     nop          / nop

nop                          / nop             /     nop          / beq t2, t3, min_one

addi t3, zero, 'Y'           / nop             /     nop          / nop
nop                          / nop             /     nop          / beq t2, t3, cccccccc

nop                          / nop             /     sb t2, 0(t1) / nop

nop                          / nop             /     nop          / halt

min_one:
addi t2, zero, -1            / nop             /     nop          / nop
nop                          / nop             /     sw t2, 0(t1) / nop
nop                          / nop             /     nop          / halt

cccccccc:
lui t2, %hi(0xCCCCCCCC)      / nop             /     nop          / nop
addi t2, t2, %lo(0xCCCCCCCC) / nop             /     nop          / nop
nop                          / nop             /     sw t2, 0(t1) / nop
nop                          / nop             /     nop          / halt
